...
class Maweo_Custom_Field_Elements
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Maweo_Custom_Field_Elements_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'maweo-custom-field-elements';
	 ...
	 *
	 * - Maweo_Custom_Field_Elements_Loader. Orchestrates the hooks of the plugin.
	 * - Maweo_Custom_Field_Elements_i18n. Defines internationalization functionality.
	 * - Maweo_Custom_Field_Elements_Admin. Defines all hooks for the admin area.
	 * - Maweo_Custom_Field_Elements_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Maweo_Custom_Field_Elements_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
